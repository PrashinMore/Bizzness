  ...
  if (loading || !user) {
    return (
      <main className="flex min-h-screen items-center justify-center bg-zinc-50">
        <p className="text-sm text-zinc-700">Loading your profile…</p>
      </main>
    );
  }
    ...
    <main className="min-h-screen bg-zinc-50 px-6 py-12">
      <div className="mx-auto flex w-full max-w-3xl flex-col gap-6">
        <header className="flex items-center justify-between rounded-3xl bg-white p-6 shadow-sm">
          <div>
            <p className="text-sm uppercase tracking-widest text-zinc-700">Profile</p>
        ...
        <article className="rounded-3xl bg-white p-6 shadow-sm">
          ...
          <dl className="mt-4 space-y-3 text-sm text-zinc-600">
            ...
            <div className="flex justify-between">
              <dt className="font-medium text-zinc-700">Last updated</dt>
              <dd className="text-zinc-900">
